              ...
              Column(
                children: [
                  Container(
                    ...
                    width: 360,
                    color: Colors.pink,
                    child: Image.asset("assets/images/river.webp",fit: BoxFit.fill),
                  ),
                  SizedBox(height: 20,),
                  ...
                  SizedBox(height: 20,),
                  Row(children: [Icon(Icons.all_inclusive),SizedBox(width: 10,),Text("manthan007",style: GoogleFonts.cinzel(textStyle: TextStyle(letterSpacing: 2),),)]),
                ],
              ),
              Column(
                children: [
                  Container(
                    ...
                    width: 340,
                    color: Colors.pink,
                    child: Image.asset("assets/images/bridge.jpg",fit: BoxFit.fill),
                  ),
                  SizedBox(height: 20,),
                  Text("Featured",style: GoogleFonts.noticiaText(fontSize: 14,letterSpacing: 4,color: Colors.grey.shade400)),
                  SizedBox(height: 15,),
